...
or a downhill,  step. Gary's hikes start and end at sea level and each step up or down represents a  unit change in
...
For example, if Gary's path is , he first enters a valley  units deep. Then he climbs out an up onto a mountain  units
